...
const veryOldInventors = inventors.filter((inventors) => {
...
const inventorNamedAda = inventors.find(inventor => inventor.first.toLowerCase() === "ada");
...
const isEveryone19OrOlder= devs.every(dev => dev.year >= 2005)
